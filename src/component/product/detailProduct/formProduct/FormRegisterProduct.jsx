...
import '../../userRegisterProduct/SelectSearch.css';
...
function FormRegisterProduct(props) {
    ...
    useEffect(() => {
        ...
        if(props.data.date !== undefined && props.data.date !== null) {
        ...
        setData({
            ...
            ProductCategoryName: props.data.category,
    ...
    const handleSubmit = async (e) => {
        ...
        if ( userData.date !== '' && userData.file1 !== '' && userData.file2 !== '' && storeValue !== '' ) {
            ...
            await axios.put(props.base_url + 'register-product', formdata, {
                headers: {
                    Authorization: 'Bearer ' + token,
                },
            }).then((res) => {
                ...
                <div className="col-lg-8 m-auto mt-3">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="col-lg-6">
                            ...
                            <input
                                disabled={props.data.date !== null && 'disabled' }
                                type="date"
                                max={maxPurchaseDate}
                                className={`form-control ${
...
export default connect(mapStateToProps, null)(FormRegisterProduct);
