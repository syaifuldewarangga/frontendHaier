  ...
  return (
    <Router forceRefresh={true}>
      <Switch>
        ...
        <Route exact path="/register_otp/:userID/:phoneNumber" component={RegisterOtp} ></Route>

        <PrivateRoute exact path="/landing-page" component={LandingPage} ></PrivateRoute>

        <PrivateRoute exact path="/product/detail/:id" component={DetailProduct} ></PrivateRoute>
        <PrivateRoute exact path="/product/register-product" component={UserRegisterProduct} ></PrivateRoute>
        <PrivateRoute exact path="/product/all-product" component={AllProduct} ></PrivateRoute>

        <PrivateRoute exact path="/shop-list" component={Shop}></PrivateRoute>
        <PrivateRoute exact path="/shop-location/:latitude/:longitude" component={Location} ></PrivateRoute>

        <PrivateRoute exact path="/service-center-list" component={ServiceCenter} ></PrivateRoute>
        <PrivateRoute exact path="/service-status" component={ServiceStatus} ></PrivateRoute>
        <PrivateRoute exact path="/service-status/detail/:id" component={DetailStatusService} ></PrivateRoute>
        ...
        <PrivateRoute exact path="/customer-voice" component={CustomerVoice} ></PrivateRoute>

        <PrivateRoute exact path="/scaner" component={CameraScan}></PrivateRoute>
        {/* END ROUTER COSTOMER */}
